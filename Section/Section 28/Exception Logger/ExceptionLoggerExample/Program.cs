...
namespace StackTraceExample
{
    ...
    class ExceptionLogger
    {
        ...
        {
            string filePath = @"C:\Users\Coditas-Admin\Documents\C #\Section\Section 28\Exception Logger\ErrorLog.txt";
    ...
    class Program
    {
        static void Main()
        {
            try
            {
                BankAccount bobBankAccount = new BankAccount() { AccountNumber = 101, AccountHolderName = "Bob", CurrentBalance = 1000 };
